...
async def run_test():
    ...
    try:
        ...
        # Attempt to access the protected user dashboard URL without login to verify redirection or blocking.
        ...
        # Attempt to access admin panel URL as non-admin user to verify access denial or redirection.
        await page.goto('http://localhost:3000/admin', timeout=10000)
        

        # Log in as admin user to test access to admin protected routes.
        frame = context.pages[-1]
        ...
        # Click the sign-in button (index 4) to submit admin login form.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/form/div[2]/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
